...
exports.incident_create_get = function (req, res) {
    ...
    exports.incident_create_post = [
        ...
        (req, res, next) => {
            ...
            if (!errors.isEmpty()) {
                ...
                res.render('incident_create_post', { title: 'Create Incident', incident: incident, errors: errors.array() });
                return;
            }
            else {
    ...
    exports.incident_update_post = [
        ...
        (req, res, next) => {
            ...
            if (!errors.isEmpty()) {
                ...
                res.render('incident_update_post', { title: 'Create Incident', incident: incident, errors: errors.array() });
                return;
            }
            else {
    ...
    exports.incident_delete_post = [
        ...
        (req, res, next) => {
            ...
            if (!errors.isEmpty()) {
                ...
                res.render('incident_delete_post', { title: 'Create Incident', incident: incident, errors: errors.array() });
                return;
            }
            else {
    ...
    exports.incident_delete_get = [
        ...
        (req, res, next) => {
            ...
            if (!errors.isEmpty()) {
                ...
                res.render('incident_delete_get', { title: 'Create Incident', incident: incident, errors: errors.array() });
                return;
            }
            else {
    ...
    exports.incident_update_get = [
        ...
        (req, res, next) => {
            ...
            if (!errors.isEmpty()) {
                ...
                res.render('incident_update_get', { title: 'Create Incident', incident: incident, errors: errors.array() });
                return;
            }
            else {
    ...
    if (!errors.isEmpty()) {
        ...
        res.render('incident_detail', { title: 'Create Incident', incident: Incident, errors: errors.array() });
        return;
    }
    else {
